...
<script type="text/javascript" src="<c:url value="/ckeditior/ckeditor.js" />"></script>
<style type="text/css">
	* {font-size: 9pt;}
...
<body>
	<form name="boardModifyForm" action="<c:url value="/BoardModifyServlet"/>" method="post" onsubmit="return boardModifyCheck()">
