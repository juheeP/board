...
<body>
	...
	<table border="1" summary="게시판 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<c:url value="/BoardViewServlet?num=${board.num}&pageNum=${boardModel.pageNum}&amp;searchType=${boardModel.searchType}&amp;searchText=${boardModel.searchText}" />"><c:out value="${board.subject}" /></a></td>
	...
	<p>
		<input type="button" value="목록" onclick="goUrl('<c:url value="/BoardListServlet2"/>');" />
		<input type="button" value="글쓰기" onclick="goUrl('<c:url value="/BoardWriteServlet"/>');" />
	</p>
</body>
</html>